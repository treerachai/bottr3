...
listApp = [
	"CHROMEOS\t2.1.5\tTRBOT\t11.2.5", 
	"DESKTOPWIN\t5.9.2\tTRBOT\t11.2.5", 
	"DESKTOPMAC\t5.9.2\tTRBOT\t11.2.5", 
	"IOSIPAD\t8.12.2\tTRBOT\t11.2.5", 
	"WIN10\t5.5.5\tTRBOT\t11.2.5"
]
try:
	for app in listApp:
		try:
			...
			try:
				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						if cmd == "logout":
							client.sendMessage(to, "Turn off selfbot successfully")
							sys.exit("[ INFO ] BOT SHUTDOWN")
							return
						elif cmd == "restart":
							client.sendMessage(to, "Successfully reset the bot")
							restartBot()
						elif cmd == "speed":
							start = time.time()
							client.sendMessage(to, "Calculate speed...")
							elapsed_time = time.time() - start
							client.sendMessage(to, "Send message speed {} seconds".format(str(elapsed_time)))
						elif cmd == "runtime":
							timeNow = time.time()
							...
							try:
								...
								ret_ +="\n╠ Auto Block Message : {}".format(settings["autoBlockMessage"])
							...
							if settings["autoAdd"] == True:
								client.sendMessage(to, "Auto add has been active")
							else:
								settings["autoAdd"] = True
								client.sendMessage(to, "Activate successfully auto add")
						elif cmd == "autoadd off":
							if settings["autoAdd"] == False:
								client.sendMessage(to, "Auto add has been disabled")
							else:
								settings["autoAdd"] = False
								client.sendMessage(to, "Disable successfully auto add")
						elif cmd == "autoblock on":
							if settings["autoBlock"] == True:
								client.sendMessage(to, "Auto Block has been active")
							else:
								settings["autoBlock"] = True
								client.sendMessage(to, "Activate successfully auto Block")
						elif cmd == "autoblock off":
							if settings["autoBlock"] == False:
								client.sendMessage(to, "Auto Block has been disabled")
							else:
								settings["autoBlock"] = False
								client.sendMessage(to, "Disable successfully auto Block")								
						elif cmd == "autojoin on":
							if settings["autoJoin"] == True:
								client.sendMessage(to, "Auto join has been active")
							else:
								settings["autoJoin"] = True
								client.sendMessage(to, "Activate successfully auto join")
						elif cmd == "autojoin off":
							if settings["autoJoin"] == False:
								client.sendMessage(to, "Auto join has been disabled")
							else:
								settings["autoJoin"] = False
								client.sendMessage(to, "Disable successfully auto join")
						elif cmd == "autojointicket on":
							if settings["autoJoinTicket"] == True:
								client.sendMessage(to, "Auto join ticket has been active")
							else:
								settings["autoJoinTicket"] = True
								client.sendMessage(to, "Activate successfully auto join ticket")
						elif cmd == "autojointicket off":
							if settings["autoJoinTicket"] == False:
								client.sendMessage(to, "Auto join ticket has been disabled")
							else:
								settings["autoJoinTicket"] = False
								client.sendMessage(to, "Disable successfully auto join ticket")
						elif cmd == "autoread on":
							if settings["autoRead"] == True:
								client.sendMessage(to, "Auto read has been active")
							else:
								settings["autoRead"] = True
								client.sendMessage(to, "Activate successfully auto read")
						elif cmd == "autoread off":
							if settings["autoRead"] == False:
								client.sendMessage(to, "Auto read has been disabled")
							else:
								settings["autoRead"] = False
								client.sendMessage(to, "Disable successfully auto read")
						elif cmd == "autorespon on":
							if settings["autoRespon"] == True:
								client.sendMessage(to, "Auto respon has been active")
							else:
								settings["autoRespon"] = True
								client.sendMessage(to, "Activate successfully auto respon")
						elif cmd == "autorespon off":
							if settings["autoRespon"] == False:
								client.sendMessage(to, "Auto respon has been disabled")
							else:
								settings["autoRespon"] = False
								client.sendMessage(to, "Disable successfully auto respon")
						elif cmd == "checkcontact on":
							if settings["checkContact"] == True:
								client.sendMessage(to, "Check details contact has been active")
							else:
								settings["checkContact"] = True
								client.sendMessage(to, "Activate successfully check details contact")
						elif cmd == "checkcontact off":
							if settings["checkContact"] == False:
								client.sendMessage(to, "Check details contact has been disabled")
							else:
								settings["checkContact"] = False
								client.sendMessage(to, "Disable successfully Check details contact")
						elif cmd == "checkpost on":
							if settings["checkPost"] == True:
								client.sendMessage(to, "Check details post has been active")
							else:
								settings["checkPost"] = True
								client.sendMessage(to, "Activate successfully check details post")
						elif cmd == "checkpost off":
							if settings["checkPost"] == False:
								client.sendMessage(to, "Check details post has been disabled")
							else:
								settings["checkPost"] = False
								client.sendMessage(to, "Disable successfully check details post")
						elif cmd == "checksticker on":
							if settings["checkSticker"] == True:
								client.sendMessage(to, "Check details sticker has been active")
							else:
								settings["checkSticker"] = True
								client.sendMessage(to, "Activate successfully check details sticker")
						elif cmd == "checksticker off":
							if settings["checkSticker"] == False:
								client.sendMessage(to, "Check details sticker has been disabled")
							else:
								settings["checkSticker"] = False
								client.sendMessage(to, "Disable successfully check details sticker")
							...
							if settings["detectUnsend"] == True:
								...
								client.sendMessage(to, "Activate successfully detect unsend")
							...
							if settings["detectUnsend"] == False:
								...
								client.sendMessage(to, "Disable successfully detect unsend")
						elif cmd.startswith("setautoaddmessage: "):
							sep = text.split(" ")
							txt = text.replace(sep[0] + " ","")
							try:
								settings["autoAddMessage"] = txt
								client.sendMessage(to, "Successfully change the auto add message to : 「{}」".format(txt))
							except:
								client.sendMessage(to, "Failed to change auto add messages")
						elif cmd.startswith("setautoblockmessage: "):
							sep = text.split(" ")
							txt = text.replace(sep[0] + " ","")
							try:
								settings["autoBlockMessage"] = txt
								client.sendMessage(to, "Successfully change the auto block message to : 「{}」".format(txt))
							except:
								client.sendMessage(to, "Failed to change auto block messages")								
						elif cmd.startswith("setautoresponmessage: "):
							sep = text.split(" ")
							txt = text.replace(sep[0] + " ","")
							try:
								settings["autoResponMessage"] = txt
								client.sendMessage(to, "Successfully change the auto response message to : 「{}」".format(txt))
							except:
							...
							if len(name) <= 20:
								...
								client.sendMessage(to, "Successfully change the name to : {}".format(name))
							...
							if 'MENTION' in msg.contentMetadata.keys()!= None:
								...
								for ls in lists:
									...
									client.sendContact(to, sender)
									client.sendMessage(to, "Clone profile successfully")
							...
							if msg.toType == 2:
								...
								if len(groupname) <= 20:
									...
									client.sendMessage(to, "Successfully change the group name to : {}".format(groupname))
						elif cmd == "openqr":
							if msg.toType == 2:
								group = client.getGroup(to)
							...
							if msg.toType == 2:
								group = client.getGroup(to)
								client.sendMessage(to, "Name Group : {}".format(group.name))
						elif cmd == "groupid":
							if msg.toType == 2:
								group = client.getGroup(to)
							...
							if msg.toType == 2:
								...
								if group.invitee is None or group.invitee == []:
									return client.sendMessage(to, "There is no cooling")
								else:
							...
							if to in read['readPoint']:
								...
								read['readMember'][to] = []
								client.sendMessage(to, "Lurking has been activated")
							else:
								try:
									del read['readPoint'][to]
									del read['readMember'][to]
							...
							if settings["mimic"]["status"] == True:
								...
								client.sendMessage(to, "Successfully activate the reply message")
						elif cmd == "mimic off":
							if settings["mimic"]["status"] == False:
								client.sendMessage(to, "Reply message has been disabled")
							else:
								settings["mimic"]["status"] = False
								client.sendMessage(to, "Successfully deactivates the reply message")
						elif cmd == "mimiclist":
								...
								for ls in lists:
									try:
										if ls in settings["mimic"]["target"]:
											...
											client.sendMessage(to, "Successfully add target")
									except:
								...
								for ls in lists:
									try:
										if ls not in settings["mimic"]["target"]:
											client.sendMessage(to, "The target is not on the list")
										else:
							...
							if lang not in language["gtts"]:
								return client.sendMessage(to, "Language {} not found".format(lang))
